...
#ifdef __GNUC__
#ifdef CTRADER_API
#define C_API_EXPORT __attribute__((dllexport))
#else
#define C_API_EXPORT __attribute__((dllimport))
#endif
#else
#ifdef CTRADER_API
...
#define NULL ((void *)0)
	...
	C_API_EXPORT void Init(InstanceID id, const char *pszFlowPath = "", bool bContinuous = false);
	...
	///用户口令更新请求
	C_API_EXPORT int ReqUserPasswordUpdate(InstanceID id, CThostFtdcUserPasswordUpdateField *pUserPasswordUpdate, int nRequestID);

	///资金账户口令更新请求
	C_API_EXPORT int ReqTradingAccountPasswordUpdate(InstanceID id, CThostFtdcTradingAccountPasswordUpdateField *pTradingAccountPasswordUpdate, int nRequestID);
	...
	///预埋撤单录入请求
	C_API_EXPORT int ReqParkedOrderAction(InstanceID id, CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID);

	///报单操作请求
	C_API_EXPORT int ReqOrderAction(InstanceID id, CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID);

	///查询最大报单数量请求
	C_API_EXPORT int C_API_EXPORT ReqQueryMaxOrderVolume(InstanceID id, CThostFtdcQueryMaxOrderVolumeField *pQueryMaxOrderVolume, int nRequestID);

	///投资者结算结果确认
	C_API_EXPORT int ReqSettlementInfoConfirm(InstanceID id, CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, int nRequestID);

	///请求删除预埋单
	C_API_EXPORT int ReqRemoveParkedOrder(InstanceID id, CThostFtdcRemoveParkedOrderField *pRemoveParkedOrder, int nRequestID);

	///请求删除预埋撤单
	C_API_EXPORT int ReqRemoveParkedOrderAction(InstanceID id, CThostFtdcRemoveParkedOrderActionField *pRemoveParkedOrderAction, int nRequestID);

	///执行宣告录入请求
	C_API_EXPORT int ReqExecOrderInsert(InstanceID id, CThostFtdcInputExecOrderField *pInputExecOrder, int nRequestID);

	///执行宣告操作请求
	C_API_EXPORT int ReqExecOrderAction(InstanceID id, CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID);
	...
	///批量报单操作请求
	C_API_EXPORT int ReqBatchOrderAction(InstanceID id, CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID);

	///期权自对冲录入请求
	C_API_EXPORT int ReqOptionSelfCloseInsert(InstanceID id, CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID);

	///期权自对冲操作请求
	C_API_EXPORT int ReqOptionSelfCloseAction(InstanceID id, CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction, int nRequestID);
	...
	///请求查询投资者持仓
	C_API_EXPORT int ReqQryInvestorPosition(InstanceID id, CThostFtdcQryInvestorPositionField *pQryInvestorPosition, int nRequestID);

	///请求查询资金账户
	C_API_EXPORT int ReqQryTradingAccount(InstanceID id, CThostFtdcQryTradingAccountField *pQryTradingAccount, int nRequestID);
	...
	///请求查询合约保证金率
	C_API_EXPORT int ReqQryInstrumentMarginRate(InstanceID id, CThostFtdcQryInstrumentMarginRateField *pQryInstrumentMarginRate, int nRequestID);

	///请求查询合约手续费率
	C_API_EXPORT int ReqQryInstrumentCommissionRate(InstanceID id, CThostFtdcQryInstrumentCommissionRateField *pQryInstrumentCommissionRate, int nRequestID);
	...
	///请求查询行情
	C_API_EXPORT int ReqQryDepthMarketData(InstanceID id, CThostFtdcQryDepthMarketDataField *pQryDepthMarketData, int nRequestID);

	///请求查询期权自对冲
	C_API_EXPORT int ReqQryOptionSelfClose(InstanceID id, CThostFtdcQryOptionSelfCloseField *pQryOptionSelfClose, int nRequestID);

	///请求查询投资者结算结果
	C_API_EXPORT int ReqQrySettlementInfo(InstanceID id, CThostFtdcQrySettlementInfoField *pQrySettlementInfo, int nRequestID);

	///请求查询合约状态
	C_API_EXPORT int ReqQryInstrumentStatus(InstanceID id, CThostFtdcQryInstrumentStatusField *pQryInstrumentStatus, int nRequestID);

	///请求查询转帐银行
	C_API_EXPORT int ReqQryTransferBank(InstanceID id, CThostFtdcQryTransferBankField *pQryTransferBank, int nRequestID);

	///请求查询投资者持仓明细
	C_API_EXPORT int ReqQryInvestorPositionDetail(InstanceID id, CThostFtdcQryInvestorPositionDetailField *pQryInvestorPositionDetail, int nRequestID);

	///请求查询客户通知
	C_API_EXPORT int ReqQryNotice(InstanceID id, CThostFtdcQryNoticeField *pQryNotice, int nRequestID);

	///请求查询结算信息确认
	C_API_EXPORT int ReqQrySettlementInfoConfirm(InstanceID id, CThostFtdcQrySettlementInfoConfirmField *pQrySettlementInfoConfirm, int nRequestID);

	///请求查询投资者持仓明细
	C_API_EXPORT int ReqQryInvestorPositionCombineDetail(InstanceID id, CThostFtdcQryInvestorPositionCombineDetailField *pQryInvestorPositionCombineDetail, int nRequestID);

	///请求查询保证金监管系统经纪公司资金账户密钥
	C_API_EXPORT int ReqQryCFMMCTradingAccountKey(InstanceID id, CThostFtdcQryCFMMCTradingAccountKeyField *pQryCFMMCTradingAccountKey, int nRequestID);

	///请求查询仓单折抵信息
	C_API_EXPORT int ReqQryEWarrantOffset(InstanceID id, CThostFtdcQryEWarrantOffsetField *pQryEWarrantOffset, int nRequestID);

	///请求查询投资者品种/跨品种保证金
	C_API_EXPORT int ReqQryInvestorProductGroupMargin(InstanceID id, CThostFtdcQryInvestorProductGroupMarginField *pQryInvestorProductGroupMargin, int nRequestID);

	///请求查询交易所保证金率
	C_API_EXPORT int ReqQryExchangeMarginRate(InstanceID id, CThostFtdcQryExchangeMarginRateField *pQryExchangeMarginRate, int nRequestID);

	///请求查询交易所调整保证金率
	C_API_EXPORT int ReqQryExchangeMarginRateAdjust(InstanceID id, CThostFtdcQryExchangeMarginRateAdjustField *pQryExchangeMarginRateAdjust, int nRequestID);

	///请求查询汇率
	C_API_EXPORT int ReqQryExchangeRate(InstanceID id, CThostFtdcQryExchangeRateField *pQryExchangeRate, int nRequestID);

	///请求查询二级代理操作员银期权限
	C_API_EXPORT int ReqQrySecAgentACIDMap(InstanceID id, CThostFtdcQrySecAgentACIDMapField *pQrySecAgentACIDMap, int nRequestID);

	///请求查询期权交易成本
	C_API_EXPORT int ReqQryOptionInstrTradeCost(InstanceID id, CThostFtdcQryOptionInstrTradeCostField *pQryOptionInstrTradeCost, int nRequestID);

	///请求查询期权合约手续费
	C_API_EXPORT int ReqQryOptionInstrCommRate(InstanceID id, CThostFtdcQryOptionInstrCommRateField *pQryOptionInstrCommRate, int nRequestID);
	...
	///请求查询转帐流水
	C_API_EXPORT int ReqQryTransferSerial(InstanceID id, CThostFtdcQryTransferSerialField *pQryTransferSerial, int nRequestID);

	///请求查询银期签约关系
	C_API_EXPORT int ReqQryAccountregister(InstanceID id, CThostFtdcQryAccountregisterField *pQryAccountregister, int nRequestID);
	...
	///请求查询预埋撤单
	C_API_EXPORT int ReqQryParkedOrderAction(InstanceID id, CThostFtdcQryParkedOrderActionField *pQryParkedOrderAction, int nRequestID);

	///请求查询交易通知
	C_API_EXPORT int ReqQryTradingNotice(InstanceID id, CThostFtdcQryTradingNoticeField *pQryTradingNotice, int nRequestID);

	///请求查询经纪公司交易参数
	C_API_EXPORT int ReqQryBrokerTradingParams(InstanceID id, CThostFtdcQryBrokerTradingParamsField *pQryBrokerTradingParams, int nRequestID);

	///请求查询经纪公司交易算法
	C_API_EXPORT int ReqQryBrokerTradingAlgos(InstanceID id, CThostFtdcQryBrokerTradingAlgosField *pQryBrokerTradingAlgos, int nRequestID);
	...
	///期货发起查询银行余额请求
	C_API_EXPORT int ReqQueryBankAccountMoneyByFuture(InstanceID id, CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID);
#ifdef __cplusplus
}
#endif
